            ...
            <form method="POST" action="{{ route('events.update', $event) }}">
                ...
                <div class="form-group">
                    <label for="is_public" class="form-toggle">
                        <input id="is_public" type="checkbox" name="is_public" value="1" {{ old('is_public', $event->is_public) ? 'checked' : '' }}>
                ...
                {{-- Organizer Info --}}
                <div x-data="{ isOrganizer: {{ old('is_organizer', $event->is_organizer ?? true) ? 'true' : 'false' }} }">
                    <div class="form-group">
                    ...
                    <div class="form-group" x-show="!isOrganizer" style="display: none;" x-transition>
                        ...
                        <x-text-input id="external_organizer_name" type="text" name="external_organizer_name"
                            :value="old('external_organizer_name', $event->external_organizer_name)"
                            placeholder="e.g. Local Mushroom Society" />
