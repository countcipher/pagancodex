...
@section('content')
    ...
    <section class="dashboard-panel" aria-labelledby="panel-create-shop">
        <div class="dashboard-panel__body">
            <header class="form-section-header">
                <h2 id="panel-create-shop">Add a New Shop to the Directory</h2>
            </header>
            ...
            <form method="POST" action="{{ route('shops.store') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-input form-input--textarea" rows="6" required
                        placeholder="Describe your shop, what you sell, your specialties, etc...">{{ old('description') }}</textarea>
