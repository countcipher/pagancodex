...
@section('content')
    ...
    <section class="dashboard-panel" aria-labelledby="panel-edit-group">
        <div class="dashboard-panel__body">
            <header class="form-section-header">
                <h2 id="panel-edit-group">Edit: {{ $group->name }}</h2>
            </header>
            ...
            <form method="POST" action="{{ route('groups.update', $group) }}">
                ...
                <div class="form-group">
                    <label for="is_public" class="form-toggle">
                        <input id="is_public" type="checkbox" name="is_public" value="1" {{ old('is_public', $group->is_public) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="name" type="text" name="name" :value="old('name', $group->name)" required autofocus
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="tradition" type="text" name="tradition" :value="old('tradition', $group->tradition)"
                ...
                <div class="form-group">
                    ...
                    <div class="form-radio-group">
                        <label class="form-radio">
                            <input type="radio" name="has_clergy" value="1" {{ old('has_clergy', $group->has_clergy) == '1' ? 'checked' : '' }}>
                            <span>Yes</span>
                        </label>
                        <label class="form-radio">
                            <input type="radio" name="has_clergy" value="0" {{ old('has_clergy', $group->has_clergy) == '0' ? 'checked' : '' }}>
                            <span>No</span>
                        </label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-input form-input--textarea" rows="6" required
                        placeholder="Describe your group, its focus, requirements to join, etc...">{{ old('description', $group->description) }}</textarea>
                ...
                <x-location-select :allowEmpty="false" :country="old('country', $group->country)"
                    :state-province="old('state_province', $group->state_province)" :city="old('city', $group->city)" />
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="contact_email" type="email" name="contact_email" :value="old('contact_email', $group->contact_email)" placeholder="contact@example.com" />
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="phone_number" type="text" name="phone_number" :value="old('phone_number', $group->phone_number)" placeholder="Optional — only share if you're comfortable" />
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="website" type="url" name="website" :value="old('website', $group->website)"
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="facebook_url" type="url" name="facebook_url" :value="old('facebook_url', $group->facebook_url)" placeholder="https://facebook.com/yourgroup" />
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="instagram_url" type="url" name="instagram_url" :value="old('instagram_url', $group->instagram_url)" placeholder="https://instagram.com/yourgroup" />
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="x_url" type="url" name="x_url" :value="old('x_url', $group->x_url)"
